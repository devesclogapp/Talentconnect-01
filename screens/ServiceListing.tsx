...
const CATEGORIES = ['All', 'Maintenance', 'Creative', 'Digital', 'Elite', 'Pet', 'Health'];
      ...
      <header className="header-glass sticky top-0 px-6 pt-12 pb-6 flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="meta !text-[8px] !lowercase text-text-tertiary leading-none">discovery matrix</p>
              <h1 className="heading-lg tracking-tight">Market Services</h1>
            </div>
          </div>
      ...
      <main className="p-6">
        {loading ? (
          <div className="py-32 flex flex-col items-center justify-center gap-4">
            ...
            <p className="meta !text-accent-primary text-[10px] animate-pulse">Syncing catalog data...</p>
          </div>
            ...
            {filteredServices.map(service => (
              ...
              >
                <div className="relative h-60 overflow-hidden">
                  <img src={service.image_url || `https://picsum.photos/seed/${service.id}/600/400`} className="w-full h-full object-cover transition-transform duration-700 group" alt={service.title} />
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="meta !text-text-primary dark:!text-white !text-[9px] !lowercase">{service.provider?.name || 'Authorized Provider'}</span>
                    </div>
                ...
                <div className="p-6 space-y-6">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <p className="heading-lg text-black dark:text-white mb-1">$ {service.base_price}</p>
                      <p className="meta !text-[8px] !lowercase text-text-tertiary">market baseline</p>
                    </div>
                  </div>
